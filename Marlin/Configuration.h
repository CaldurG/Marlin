...
// show feedrate on status screen
//#define STATUS_SCREEN_FEEDRATE

// show XYZ coordinates on status screen
//#define STATUS_SCREEN_XYZ

// show elapsed print time with days
//#define STATUS_SCREEN_DAYS
...
#define BLTOUCH
  ...
  #define BLTOUCH_DELAY 20   // (ms) Enable and increase if needed (default 375)
#endif
